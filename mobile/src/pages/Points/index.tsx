...
const Points: React.FC<Props> = ({navigation, route}) => {
  ...
  return (
      ...
      <View style={styles.mapContainer}>
        ...
        >
          {points.map(point=>(
            ...
            onPress={()=>{navigation.navigate("Detail", point.id)}}
          >
    ...
    <View style={styles.itemsContainer}>
      <ScrollView 
        ...
        contentContainerStyle={{paddingHorizontal: 20}} // padding que nao corta conteudo
      >
        {items.map(item=>{
          return (
            <TouchableOpacity 
              ...
              style={[
                styles.item,
                selectedItems.includes(Number(item.id)) ? styles.selectedItem : {}
              ]} 
